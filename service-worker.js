...
const APP_SHELL = [
  ...
  './clear-cache.html',
  './manifest.json',
  './assets/css/style.css?v=1.0.85',
  './assets/js/supabase.min.js?v=1.0.85',
  './assets/js/supabase-config.js?v=1.0.85',
  './assets/js/app.js?v=1.0.85',
